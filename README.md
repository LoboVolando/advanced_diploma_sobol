...
* метрики
  ...
  * prometheus
    * nginx-exporter
    * postgresql - присутствуют в pgAdmin
    * web
...
```
cd existing_repo
git remote add origin https://gitlab.com/0507033/advanced_diploma.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/0507033/advanced_diploma/-/settings/integrations)
